...
>
        ...
        <p class="text-m text-[15px]">
                A: You can contribute to this project by submitting a dev application in the Organisation's <a
                        href="https://github.com/suyu-emu"><u>GitHub</u></a
                > page, once you have access, we will help set you up and you can submit your changes as a pull request in the project repository. We are always looking for new contributors to help us improve the project!
        </p>
        <p class="text-[15px] leading-[1.41] md:text-[19px] md:leading-[1.1]">
